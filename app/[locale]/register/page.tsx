  ...
  return (
    <div className="container-shell py-8 md:py-12">
      <div className="mx-auto w-full max-w-[900px]">
        <PageHero eyebrow="Auth" title={dictionary.auth.registerTitle} subtitle={dictionary.auth.registerHint} />
        ...
        <section className="panel mt-8 p-6 md:p-8">
          <form className="grid gap-4" action={registerAction.bind(null, locale)}>
            <label className="field-label">
              <span>{dictionary.auth.name}</span>
              <input className="field" type="text" name="display_name" placeholder="Writer / artist name" required />
            </label>
            <label className="field-label">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-3">
              <FormButton pendingLabel="Создаём аккаунт…">{dictionary.auth.buttonRegister}</FormButton>
              <Link href={`/${locale}/login`} className="button-secondary">
