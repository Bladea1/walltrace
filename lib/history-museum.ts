...
export type MuseumEra = {
  ...
  whyItMatters: string;
  milestones: string[];
  galleryNotes: { title: string; caption: string; word: string }[];
  figures: MuseumFigure[];
};

export type MuseumHistoryLocale = {
  hero: {
    eyebrow: string;
    title: string;
    subtitle: string;
  ...
  readingRoom: {
    eyebrow: string;
    title: string;
    items: { title: string; text: string; word: string }[];
  };
  curatorSection: {
    eyebrow: string;
    title: string;
...
export const museumHistory: Record<'ru' | 'en', MuseumHistoryLocale> = {
  ru: {
    hero: {
      eyebrow: 'Museum Mode',
      title: 'История граффити как живая выставка',
      subtitle:
        'Не лента из пары карточек, а насыщенный маршрут через подпись, поезд, стиль, медиа, музей и цифровой архив.',
      lead:
        'Этот раздел собран как музейная экспозиция: с эпохами, ключевыми фигурами, визуальными акцентами и пояснениями о том, как граффити прошло путь от городской метки до глобальной культурной системы.',
      stats: [
        { value: '5', label: 'Ключевых эпох' },
        { value: '8', label: 'Пионеров и медиаторов' },
        { value: '20+', label: 'Исторических поворотных точек' },
      ],
    },
    ...
    eras: [
      {
        ...
        summary:
          'Ранние подписи появляются как способ заявить о себе и занять место в городской ткани. Важна не только форма, но и сам факт повторения имени на маршрутах, стенах и транспорте.',
        whyItMatters:
          'Именно здесь появляется логика “быть увиденным”: имя становится медиа, а город — первой распределённой сетью распространения граффити.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Имя Darryl McCray стало одним из символов того момента, когда городская подпись превратилась в историю, легенду и модель для подражания.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Известность TAKI 183 резко выросла после статьи в The New York Times в 1971 году. Его пример сделал tagging видимым для всего города.',
            contributions: [
      ...
      },
      {
        ...
        summary:
          'Когда райтеры массово выходят на поезда, граффити меняет масштаб. Вагон превращается в передвижную стену, а стиль — в соревнование видимости и сложности.',
        whyItMatters:
          'Субвей делает граффити публичным в масштабе всего города. Работа больше не привязана к одному углу — она движется и становится коллективным визуальным опытом.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Одна из ключевых фигур ранней сцены, связанная с развитием bubble letters, организацией сцены и переводом граффити в культурное самосознание хип-хопа.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Творческая логика Tracy 168 связана с рождением wildstyle — сложного письма, где буква превращается в лабиринт ритмов и направлений.',
            contributions: [
      ...
      },
      {
        ...
        summary:
          'В конце 1970-х и в 1980-е граффити достигает визуальной зрелости. Whole cars, сложные композиции, персонажи и коллаборации выводят сцену в поп-культуру и арт-медиа.',
        whyItMatters:
          'Именно этот период сделал граффити мировым образом города. Книги, кино и фотография закрепили сцену в коллективной памяти далеко за пределами Нью-Йорка.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Lee Quiñones помог превратить вагон в сложное художественное поле, где граффити, персонажи и сообщение работают как единая драматургия.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Lady Pink показала, что граффити — это не закрытый мужской клуб, а поле, где можно добиться авторитетного места через стиль, дерзость и устойчивость.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Futura 2000 важен как фигура, которая радикально расширила язык граффити в сторону абстракции, живописи и межсценового диалога.',
            contributions: [
      ...
      },
      {
        ...
        summary:
          'После зачистки субвея граффити не исчезает. Оно меняет инфраструктуру: переходит на стены, в международные поездки, фестивали, фотоархивы, журналы и ранний интернет.',
        whyItMatters:
          'Сцена становится глобальной не только эстетически, но и организационно: стили циркулируют быстрее, а локальные школы начинают влиять друг на друга.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'SEEN стал одной из самых узнаваемых фигур graffiti-writing, символом того, как локальная subway fame может превратиться в глобальное имя.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Без фотографии и книги Subway Art большая часть раннего граффити осталась бы лишь городской легендой. Они сделали сцену видимой для мира и для будущего.',
            contributions: [
      ...
      },
      {
        ...
        summary:
          'Сегодня граффити живёт сразу в нескольких режимах: как улица, как mural practice, как часть музеев и как цифровой архив. Сцена документирует сама себя быстрее и точнее, чем когда-либо.',
        whyItMatters:
          'Без архивной инфраструктуры граффити теряет контекст. Платформы, музеи и базы данных помогают сохранить не только изображение, но и автора, место, время, стиль и связи между поколениями.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Daze важен как пример того, как райтер может сохранить связь со сценой и одновременно развить музейную и галерейную карьеру.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Современную историю граффити формируют не только райтеры, но и те, кто создаёт музеи, архивы, каталоги, интервью и цифровые платформы вроде WALLTRACE.',
            contributions: [
    ...
    figureSection: {
      ...
      subtitle:
        'От первичных тегов до медиа, книг и музейных пространств — история граффити строится не одной звездой, а целой цепью фигур, каждая из которых меняла масштаб, стиль или инфраструктуру сцены.',
    },
    readingRoom: {
  ...
  en: {
    hero: {
      ...
      subtitle:
        'Not a thin list of cards, but a dense route through the tag, the train, style writing, media, museums, and the digital archive.',
      lead:
        'This section is built like a museum exhibition with eras, pivotal figures, visual anchors, and explanations of how graffiti moved from urban mark-making to a global cultural system.',
      stats: [
        { value: '5', label: 'Major eras' },
        { value: '8', label: 'Pioneers and mediators' },
        { value: '20+', label: 'Turning points' },
      ],
    },
    ...
    eras: [
      {
        ...
        kicker: 'Philadelphia / New York / existence politics',
        summary:
          'Early signatures emerge as a way to claim visibility and occupy space in the city. The key issue is not only form, but repetition: the same name returning across walls, routes, and transit.',
        whyItMatters:
          'This is where the logic of “being seen” begins: the name becomes media, and the city becomes the first distributed network for graffiti.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Darryl McCray became a symbol of the moment when the urban signature turned into legend, story, and a model for others.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'TAKI 183 became widely known after the 1971 New York Times article, accelerating imitation and making tagging legible to the whole city.',
            contributions: [
      ...
      },
      {
        ...
        kicker: 'Tagging / throw-up / whole car',
        summary:
          'Once writers move massively onto trains, graffiti changes scale. The subway car becomes a mobile wall, and style becomes a competition of visibility, complexity, and rhythm.',
        whyItMatters:
          'The subway turns graffiti into a citywide public image system. The work is no longer tied to one corner—it moves and becomes a collective visual experience.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'A central figure of the early scene, Phase 2 is closely tied to the development of bubble letters and the self-conscious cultural identity of hip-hop graffiti.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Tracy 168 is linked to the birth of wildstyle, where the letter becomes a maze of motion, compression, and coded rhythm.',
            contributions: [
      ...
      },
      {
        ...
        kicker: 'Wild Style / Style Wars / global recognition',
        summary:
          'By the late 1970s and 1980s graffiti reaches visual maturity. Whole cars, dense color, characters, and collaboration push the scene into pop culture and art media.',
        whyItMatters:
          'This is the period that made graffiti a global image of the city. Books, film, and photography turned a local scene into international cultural memory.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Lee Quiñones helped turn the train car into a complex pictorial field where graffiti, character work, and social messaging could operate together.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Lady Pink showed that graffiti was not a closed male arena. She carved out a respected position through style, nerve, and long-term artistic persistence.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Futura 2000 is important for radically widening graffiti’s language toward abstraction, painting, music, and broader cultural crossover.',
            contributions: [
      ...
      },
      {
        ...
        kicker: 'Europe / festivals / internet / legal walls',
        summary:
          'After the subway crackdown, graffiti does not disappear. It changes infrastructure: moving to walls, international travel, festivals, photo archives, magazines, and the early web.',
        whyItMatters:
          'The scene becomes global not only aesthetically but organizationally. Styles circulate faster, and local schools begin influencing each other across borders.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'SEEN became one of the most recognizable names in writing culture, symbolizing how local subway fame could become global presence.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Without photography and Subway Art, much of early graffiti would remain legend. Their work made the scene visible to the world and to the future.',
            contributions: [
      ...
      },
      {
        ...
        kicker: 'archives / preservation / platform logic',
        summary:
          'Today graffiti exists in several modes at once: as street practice, mural culture, museum subject, and digital archive. The scene now documents itself faster and more thoroughly than ever.',
        whyItMatters:
          'Without archival infrastructure, graffiti loses context. Platforms, museums, and databases preserve not just the image, but the author, place, date, style, and links across generations.',
        milestones: [
        ...
        figures: [
          {
            ...
            summary:
              'Daze matters because he shows how a writer can retain a deep link to the scene while also developing a museum and studio practice.',
            contributions: [
          ...
          },
          {
            ...
            summary:
              'Contemporary graffiti history is shaped not only by writers, but also by those building museums, archives, catalogs, interviews, and digital platforms such as WALLTRACE.',
            contributions: [
    ...
    figureSection: {
      ...
      subtitle:
        'From the earliest tags to books, film, and museums, graffiti history is built by a chain of people—each changing scale, style, visibility, or the memory infrastructure around the scene.',
    },
    readingRoom: {
      eyebrow: 'Reading room',
